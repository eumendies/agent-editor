...
class MemoryPackageStructureTest {
    ...
    void shouldExposeCompressionContractFromCoreMemoryPackage() {
        assertEquals("com.agent.editor.agent.core.memory", MemoryCompressor.class.getPackageName());
        assertEquals("com.agent.editor.agent.core.memory", MemoryCompressionRequest.class.getPackageName());
        assertEquals("com.agent.editor.agent.core.memory", MemoryCompressionResult.class.getPackageName());
